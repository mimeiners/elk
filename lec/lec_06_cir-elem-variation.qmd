...
Perform a Monte Carlo analysis and find the mean\, standard deviation\, min\, and max for VO\, II\, and power delivered from the source\.
...
Quelle: Microelectronic Circuit Design\, Jaeger/Blalock\, 6\. Ed\.\, Kap\. 4\, Ex\. 4\.11
...
Extremes of VCE are: 7\.06 V \(forward\-active region\) and 0\.471 V \(saturated\, hence calculated values for VCE and IC actually not correct\)\.
...
Quelle: Microelectronic Circuit Design\, Jaeger/Blalock\, 6\. Ed\.\, Kap\. 4\, Ex\. 4\.12

## Tolerances - Monte Carlo Analysis

<span style="color:#0000ff">Example \(cont\.\)</span>



* Full results of Monte Carlo analysis of 500 cases of the 4\-resistor bias circuit yields mean values of 207 mA and 4\.06 V for  _I_  _C_  and  _V_  _CE_  respectively which are close to values originally estimated from nominal circuit elements\.
