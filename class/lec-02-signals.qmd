...
After digitization\, the continuous analog signal becomes a set of discrete valueAnalog electrical signals are
continuous in time \- most often voltage or current\.  \(Charge can also be utilized as a signal conveyor\.\)
