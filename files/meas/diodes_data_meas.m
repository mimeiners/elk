...
writeline(RP,strcat("SOUR1:PHAS " + str(phase))  % Phase
...
writeline(RP,'ACQ:DEC 16');  % Decimation 64
writeline(RP,'ACQ:TRIG:LEV 0');  % Trigger level
...
% save('./data/IN_UB_VBS_VBP.mat', 'DF_IN1', 'DF_IN2');
% save('./data/IN1_UB_VBS.mat', 'DF_IN1');
% save('./data/IN2_UB_VBP.mat', 'DF_IN2');

%% Save data as parquet file
% parquet data is of type table, no matrix operations
parquetwrite('data/IN1_D1.parquet', array2table(DF_IN1));
parquetwrite('data/IN2_D1.parquet', array2table(DF_IN2));
