...
Data_elie = np.loadtxt("../Red Pitayas Messwerte/rpScopeData_elie1_Diode_1N4001.txt", delimiter = ",") #je nach Versuch den Pfad(Dateiname) anpassen
...
# Load Spice-Data
Data_Spice = np.loadtxt("../Spice-Messwerte/Draft_Diode_1N4001.txt", delimiter = "\t") #je nach Versuch den Pfad (Dateiname) anpassen
...
plt.title("Diode 1N4001 erzeugende Signale in Spice") #Titel je nach Versuch anpsassen
...
plt.title("Dioden (1N4001) IV-Charakteristik in Spice") #Titel je nach Versuch anpsassen
...
# Plot Eingangs- und Diodenspanung als funktion der Zeit
fig, ax1 = plt.subplots(figsize = (12, 6))
plt.title("Diode 1N4001 erzeugende Signale im Labor (Red Pitaya)") #Titel je nach Versuch anpsassen
plt.xlabel("Zeit in ms")
plt.grid()
...
plt.figure(4)
plt.figure(figsize = (12, 6))
plt.title("Dioden (1N4001) IV-Charakteristik mit Red Pitayas Werte") #Titel je nach Versuch anpsassen
...
fig, ax1 = plt.subplots(figsize = (12, 6))
plt.title("Diode 1N4001 erzeugende Signale mit Spices und Red Pitayas Werte") #Titel je nach Versuch anpsassen
plt.xlabel("Zeit in ms")
plt.grid()
...
plt.figure(6)
plt.figure(figsize = (12, 6))
plt.title("Dioden (1N4001) IV-Charakteristik mit Spices und Red Pitayas Werte") #Titel je nach Versuch anpsassen
...
fig, ax1 = plt.subplots(figsize = (12, 6))
plt.title("Diode 1N4001 Abweichungen über die Zeit zwischen Spices und Red Pitayas Werte") #Titel je nach Versuch anpsassen
plt.xlabel("Zeit in ms")
plt.grid()
